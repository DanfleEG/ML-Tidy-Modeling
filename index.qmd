---
title: "Software para el Modelado"
subtitle: "Fundamentos de Modelado Estadístico y Machine Learning"
...
<div class="cover-wrap">
  ...
  <div class="cover-meta">
    ...
    <div class="cover-meta-item">
      <span class="cover-meta-label">Duración</span>
...
<div class="timeline">
  ...
  <div class="tl-item">
    ...
    <div class="tl-body">Orientado al EDA — el modelo sirve a la curiosidad del analista, no a un estándar externo.</div>
  </div>
</div>
```
:::
...
<div class="concept-box" style="margin-top:0.9rem;">
  <p>Ambos tipos comparten un imperativo común: la <strong>generalización</strong> — el rendimiento sobre datos que el modelo nunca ha visto.</p>
</div>
```
...
```{=html}
<p style="font-size:0.9rem;color:var(--ink-muted);margin-bottom:1rem;">
Predicción de la afluencia diaria en el metro — el monólogo interno de un analista.
</p>
...
<div class="card-grid four">
  ...
  <div class="card">
    <span class="card-icon">📊</span>
    <div class="card-title">Paso 1 · Correlaciones</div>
    <div class="card-body">¿Qué estaciones covarían? ¿La afluencia está autocorrelacionada? Emergen estacionalidades semanal y mensual.</div>
  </div>

  <div class="card">
    <span class="card-icon">🌡️</span>
    <div class="card-title">Paso 2 · Clima</div>
    <div class="card-body">Temperatura y precipitación se incorporan como características. Los días fríos y lluviosos reducen la afluencia de forma no lineal.</div>
  </div>

  <div class="card">
    <span class="card-icon">📅</span>
    <div class="card-title">Paso 3 · Festivos</div>
    <div class="card-body">Los días festivos federales y locales generan caídas abruptas. Se codifican como variables indicadoras binarias.</div>
  </div>

  <div class="card">
    <span class="card-icon">🌲</span>
    <div class="card-title">Paso 4 · Boosted Trees</div>
    <div class="card-body">XGBoost captura interacciones no lineales entre clima, calendario y efectos a nivel de estación.</div>
  </div>

</div>

<div class="concept-box teal" style="margin-top:1rem;">
  <p>El analista nunca ajusta un modelo primero — cada característica está motivada por <strong>razonamiento de dominio</strong> antes que por evidencia estadística.</p>
</div>
```
...
<div style="display:flex;flex-direction:column;gap:0.85rem;margin-top:0.5rem;">
  ...
  <div class="concept-box">
    <p>🔄 <strong>El modelado es iterativo</strong><br>
    <span style="font-size:0.85rem;color:var(--ink-muted);">EDA, ingeniería de características, ajuste y evaluación forman un ciclo — no una secuencia.</span></p>
  </div>

  <div class="concept-box">
    <p>🧰 <strong>El software moldea la práctica</strong><br>
    <span style="font-size:0.85rem;color:var(--ink-muted);">Las buenas herramientas garantizan la reproducibilidad, protegen contra el data leakage y hacen de la práctica correcta el comportamiento por defecto.</span></p>
  </div>

  <div class="concept-box teal">
    <p>🤝 <strong>ML y estadística son complementarios</strong><br>
    <span style="font-size:0.85rem;color:var(--ink-muted);">El machine learning aporta fidelidad predictiva; la estadística aporta rigor inferencial. Ambos son necesarios.</span></p>
  </div>
