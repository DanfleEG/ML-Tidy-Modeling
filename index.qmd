...
<!-- 1. CONTENEDOR MAESTRO: Controla el ancho del 62% y centra todo el bloque -->
<div style="width:62%; margin:0 auto; box-sizing:border-box;">

  <!-- 2. CONTENEDOR DE LA IMAGEN (Ocupa el 100% de su padre) -->
  <div style="height:420px; border-radius:8px; overflow:hidden;">
    <img src="/images/chicago_train.png"
         alt="Chicago L train elevated railway at night"
         style="width:100%; height:100%; object-fit:cover; display:block;">
  </div>

  <!-- 3. TARJETA DEBAJO (Ocupa el 100% de su padre) -->
  <div style="background:var(--surface); border:1px solid var(--rule); border-radius:10px; padding:1.6rem; margin-top:0.5rem; text-align:center; box-sizing:border-box;">
    ...
    <div style="margin-top:1.4rem;">
      <!-- Agregamos flex-wrap:wrap para que las etiquetas bajen si no hay espacio, en vez de estirar la tarjeta -->
