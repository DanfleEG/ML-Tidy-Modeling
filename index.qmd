...
<div  
  ...
  <div style="flex:0 0 280px; display:flex; flex-direction:column; gap:0.6rem;">
    ...
    <div style="background:rgba(45,106,159,0.03); border:1px solid rgba(45,106,159,0.12); border-radius:6px; padding:0.45rem 0.8rem;">
      <div style="font-family:'DM Sans',sans-serif; font-weight:400; font-size:0.8rem; color:#1a1a2e;">Danilo David, Estrella Guerra</div>
      <div style="font-family:'JetBrains Mono',monospace; font-size:0.65rem; color:#5c5c7a; margin-top:0.1rem;">20220763</div>
    </div>

    <div style="background:rgba(45,106,159,0.03); border:1px solid rgba(45,106,159,0.12); border-radius:6px; padding:0.45rem 0.8rem;">
      <div style="font-family:'DM Sans',sans-serif; font-weight:400; font-size:0.8rem; color:#1a1a2e;">Ramón Davalillo</div>
      <div style="font-family:'JetBrains Mono',monospace; font-size:0.65rem; color:#5c5c7a; margin-top:0.1rem;">20230389</div>
    </div>

    <div style="background:rgba(45,106,159,0.03); border:1px solid rgba(45,106,159,0.12); border-radius:6px; padding:0.45rem 0.8rem;">
      <div style="font-family:'DM Sans',sans-serif; font-weight:400; font-size:0.8rem; color:#1a1a2e;">Arévalo Aquije Eduardo</div>
      <div style="font-family:'JetBrains Mono',monospace; font-size:0.65rem; color:#5c5c7a; margin-top:0.1rem;">20220756</div>
    </div>

    <div style="background:rgba(45,106,159,0.03); border:1px solid rgba(45,106,159,0.12); border-radius:6px; padding:0.45rem 0.8rem;">
      <div style="font-family:'DM Sans',sans-serif; font-weight:400; font-size:0.8rem; color:#1a1a2e;">José Ignacio Gamarra</div>
...
<div class="card-grid four">
  ...
  <div class="card">
    <span class="card-icon">📊</span>
    <div class="card-title">Paso 1 · Análisis exploratorio (EDA)</div>
    <div class="card-body">Se identifica que los valores de afluencia entre las estaciones están extremadamente correlacionados. Además, se observa que el comportamiento del transporte en los fines de semana es significativamente distinto al de los días laborables.</div>
  </div>

  <div class="card">
    <span class="card-icon">🌡️</span>
    <div class="card-title">Paso 2 · Ingeniería de funciones inicial</div>
    <div class="card-body">Las fechas se codifican por día de la semana y año. Se considera el uso del Análisis de Componentes Principales (PCA) sobre los predictores correlacionados para simplificar la estructura de los datos que recibirá el modelo.</div>
  </div>

  <div class="card">
    <span class="card-icon">📅</span>
    <div class="card-title">Paso 3 · Evaluación y selección de modelos</div>
    <div class="card-body">Se ponen a prueba algoritmos como regresión lineal, K-vecinos cercanos (KNN) y árboles potenciados (boosted trees). Durante la evaluación, las puntuaciones de importancia de variables indican que el clima no tiene capacidad predictiva, por lo que se decide eliminarlo del análisis.</div>
  </div>

  <div class="card">
    <span class="card-icon">🌲</span>
    <div class="card-title">Paso 4 · Refinamiento iterativo</div>
    <div class="card-body">Para corregir errores en fechas específicas, se codifican indicadores para los días festivos. Finalmente, se descarta el modelo KNN y se opta por optimizar el número de iteraciones en el modelo de árboles potenciados para alcanzar el rendimiento deseado.</div>
  </div>

</div>

<div class="concept-box teal" style="margin-top:1rem;">
  <p>El analista no se limita a ajustar un algoritmo: el modelo final es el resultado de un ciclo donde la evaluación del rendimiento motiva nuevas etapas de ingeniería de funciones y análisis exploratorio.</p>
</div>
```
